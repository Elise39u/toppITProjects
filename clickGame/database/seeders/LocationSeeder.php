    ...
    public function run(): void
    {
        ...
        DB::table('locations')->insert(['id' => 1, 'name' => 'A new adventure in new york!', 'area_id' => 1,
            ...
            'story' => 'You wake up after a nap what feels like for ever <br />
                    ...
                    ']);
        DB::table('choices')->insert(['name' => 'Go to the kitchen', 'from_location_id' => 1, 'to_location_id' => 2]);
        DB::table('choices')->insert(['name' => 'Go to the bathroom', 'from_location_id' => 1, 'to_location_id' => 3]);
        DB::table('choices')->insert(['name' => 'Go to the windows', 'from_location_id' => 1, 'to_location_id' => 4]);
        DB::table('choices')->insert(['name' => 'Go to the hallways of the hotel', 'from_location_id' => 1, 'to_location_id' => 5]);
        ...
        DB::table('choices')->insert(['name' => 'Go back to your hotel room.', 'from_location_id' => 2, 'to_location_id' => 1]);
        DB::table('choices')->insert(['name' => 'Go to the bathroom', 'from_location_id' => 2, 'to_location_id' => 3]);
        ...
        DB::table('choices')->insert(['name' => 'Go back to your hotel room', 'from_location_id' => 3, 'to_location_id' => 1]);
        ...
        DB::table('choices')->insert(['name' => 'Back off from the window', 'from_location_id' => 4, 'to_location_id' => 1]);
        ...
        DB::table('choices')->insert(['name' => 'Go back to your hotel room', 'from_location_id' => 5, 'to_location_id' => 1]);
        DB::table('choices')->insert(['name' => 'Go outside to explore new york', 'from_location_id' => 5, 'to_location_id' => 6]);
        ...
        DB::table('choices')->insert(['name' => 'Go back inside the hotel', 'from_location_id' => 6, 'to_location_id' => 5]);
        DB::table('choices')->insert(['name' => 'Go to the wood store', 'from_location_id' => 6, 'to_location_id' => 7]);
        DB::table('choices')->insert(['name' => 'Go to the gadget store', 'from_location_id' => 6, 'to_location_id' => 8]);
